...
",
    ...
    map_identifiers(&ast.0.expressions, (0, u64::MAX), 3, &mut |ident| {
...
",
    ...
    map_identifiers(&ast.0.expressions, (0, u64::MAX), 5, &mut |ident| {
        comps.push(ident.to_owned())
    });
...
",
    ...
    map_identifiers(&ast.0.expressions, (0, u64::MAX), 2, &mut |ident| {
        comps.push(ident.to_owned())
    });
...
",
    ...
    map_identifiers(&ast.0.expressions, (0, u64::MAX), 6, &mut |ident| {
        comps.push(ident.to_owned())
    });
...
",
    ...
    map_identifiers(&ast.0.expressions, (0, u64::MAX), 4, &mut |ident| {
        comps.push(ident.to_owned())
    });
